...
mkdir -p mob_suite bakta amrfinderplus
...
do
    ...
    mob_recon -i $assembly -o mob_suite/${sample} --force
done
...
for aa in bakta/enterobacter_unicycler_vim_plasmid_aa919/enterobacter_unicycler_vim_plasmid_aa919.faa bakta/pputida_trycycler_vim_plasmid_ac907/pputida_trycycler_vim_plasmid_ac907.faa bakta/proteus_unicycler_vim_plasmid_ac082/proteus_unicycler_vim_plasmid_ac082.faa;
do 
    amrfinder -p $aa --plus -o amrfinderplus/$(basename $aa | cut -d '.' -f1)  --database /bioinf/anaconda3/envs/amrfinderplus2/bin/data/2023-09-26.1/
done
